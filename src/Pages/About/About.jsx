      ...
      <div className="about-page section">
        <section className="about-hero-section container">
          ...
          <div className="about-hero-content">
            ...
            <p>
              At Jamii Hostels, we understand the challenges students face when
              searching for accommodation. Our platform connects university
              students with quality hostels, making it easy to{" "}
              <NavLink to="/hostels" className="inline-link">
        ...
        <section className="about-mission-section container">
          <div className="about-mission-container section section-bottom">
            <div className="about-mission-text">
              ...
              <h2>Our Mission</h2>
              <p>
                We're dedicated to transforming the way university students find
                accommodation. By providing a comprehensive platform that
                showcases detailed hostel listings, virtual tours, and seamless
                booking processes, we eliminate the stress and uncertainty from
                your housing search.{" "}
                <NavLink to="/role-selection" className="inline-link">
                  Browse, compare, and secure
                </NavLink>{" "}
                your ideal student accommodation—all from your device.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="about-services-grid container section">
              <div className="about-service-card">
                ...
                <p>
                  ...
                  amenities, and distance from your university to discover the
                  ideal hostel that matches your preferences.{" "}
                  <NavLink to="/hostels" className="inline-link">
                    Start searching now
                  </NavLink>
                  .
              ...
              <div className="about-service-card">
                ...
                <p>
                  ...
                  virtual tours. Browse through high-quality photos, 360° room
                  views, and detailed floor plans to make informed decisions
                  about your accommodation without physical visits.{" "}
                  <NavLink to="/hostels" className="inline-link">
              ...
              <div className="about-service-card">
                ...
                <p>
                  ...
                  booking platform. Enjoy transparent pricing, instant
                  confirmation, and safe payment processing, making your
                  accommodation booking process smooth and worry-free.{" "}
                  <NavLink to="/role-selection" className="inline-link">
                    Create an account
                  </NavLink>{" "}
                  to get started.
        ...
        <section className="values-section container section section-bottom">
          ...
          <div className="values-grid">
            <div className="value-item">
              <h3>Time-Saving</h3>
              <p>
                No more traveling around campus looking for accommodation.{" "}
                <NavLink to="/" className="inline-link">
                  Learn more
                </NavLink>{" "}
                about how we save you time.
              </p>
            </div>
            <div className="value-item">
              <h3>Verified Listings</h3>
              <p>
                All hostels are verified to ensure you get exactly what you see.{" "}
                <NavLink to="/faqs" className="inline-link">
                  Read our FAQs
                </NavLink>{" "}
                to learn about our verification process.
              </p>
            </div>
            <div className="value-item">
              <h3>Student Community</h3>
              <p>
                Join a community of students who share reviews and experiences.{" "}
                <NavLink to="/contacts" className="inline-link">
                  Contact us
                </NavLink>{" "}
                to learn more about our student community.
              </p>
            </div>
          </div>
        </section>
